...
bool cdr_serialize_my_service_interfaces__srv__SetVelocity_Request(
  const my_service_interfaces__srv__SetVelocity_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
bool cdr_deserialize_my_service_interfaces__srv__SetVelocity_Request(
  eprosima::fastcdr::Cdr & cdr,
  my_service_interfaces__srv__SetVelocity_Request * ros_message)
{
  // Field name: linear
  {
    cdr >> ros_message->linear;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
bool cdr_serialize_key_my_service_interfaces__srv__SetVelocity_Request(
  const my_service_interfaces__srv__SetVelocity_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: linear
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
size_t get_serialized_size_key_my_service_interfaces__srv__SetVelocity_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetVelocity_Request__ros_msg_type * ros_message = static_cast<const _SetVelocity_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
size_t max_serialized_size_key_my_service_interfaces__srv__SetVelocity_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_service_interfaces__srv__SetVelocity_Request * ros_message = static_cast<const my_service_interfaces__srv__SetVelocity_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_service_interfaces__srv__SetVelocity_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_service_interfaces__srv__SetVelocity_Request * ros_message = static_cast<my_service_interfaces__srv__SetVelocity_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_service_interfaces__srv__SetVelocity_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
bool cdr_serialize_my_service_interfaces__srv__SetVelocity_Response(
  const my_service_interfaces__srv__SetVelocity_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
bool cdr_deserialize_my_service_interfaces__srv__SetVelocity_Response(
  eprosima::fastcdr::Cdr & cdr,
  my_service_interfaces__srv__SetVelocity_Response * ros_message)
{
  // Field name: success
  {
    uint8_t tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
bool cdr_serialize_key_my_service_interfaces__srv__SetVelocity_Response(
  const my_service_interfaces__srv__SetVelocity_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
size_t get_serialized_size_key_my_service_interfaces__srv__SetVelocity_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetVelocity_Response__ros_msg_type * ros_message = static_cast<const _SetVelocity_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
size_t max_serialized_size_key_my_service_interfaces__srv__SetVelocity_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_service_interfaces__srv__SetVelocity_Response * ros_message = static_cast<const my_service_interfaces__srv__SetVelocity_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_service_interfaces__srv__SetVelocity_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_service_interfaces__srv__SetVelocity_Response * ros_message = static_cast<my_service_interfaces__srv__SetVelocity_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_service_interfaces__srv__SetVelocity_Response(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
bool cdr_serialize_my_service_interfaces__srv__SetVelocity_Event(
  const my_service_interfaces__srv__SetVelocity_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_my_service_interfaces__srv__SetVelocity_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_my_service_interfaces__srv__SetVelocity_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
bool cdr_deserialize_my_service_interfaces__srv__SetVelocity_Event(
  eprosima::fastcdr::Cdr & cdr,
  my_service_interfaces__srv__SetVelocity_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_my_service_interfaces__srv__SetVelocity_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_my_service_interfaces__srv__SetVelocity_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
bool cdr_serialize_key_my_service_interfaces__srv__SetVelocity_Event(
  const my_service_interfaces__srv__SetVelocity_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_my_service_interfaces__srv__SetVelocity_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_my_service_interfaces__srv__SetVelocity_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
size_t get_serialized_size_key_my_service_interfaces__srv__SetVelocity_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetVelocity_Event__ros_msg_type * ros_message = static_cast<const _SetVelocity_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_my_service_interfaces__srv__SetVelocity_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_my_service_interfaces__srv__SetVelocity_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_service_interfaces
size_t max_serialized_size_key_my_service_interfaces__srv__SetVelocity_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_my_service_interfaces__srv__SetVelocity_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_my_service_interfaces__srv__SetVelocity_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_service_interfaces__srv__SetVelocity_Event * ros_message = static_cast<const my_service_interfaces__srv__SetVelocity_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_service_interfaces__srv__SetVelocity_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_service_interfaces__srv__SetVelocity_Event * ros_message = static_cast<my_service_interfaces__srv__SetVelocity_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_service_interfaces__srv__SetVelocity_Event(cdr, ros_message);
}
