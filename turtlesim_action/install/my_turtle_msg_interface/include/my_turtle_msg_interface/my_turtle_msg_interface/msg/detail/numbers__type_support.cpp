...
{
  new (message_memory) my_turtle_msg_interface::msg::Numbers(_init);
}

void Numbers_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_turtle_msg_interface::msg::Numbers *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Numbers_message_member_array[2] = {
  {
    ...
    offsetof(my_turtle_msg_interface::msg::Numbers, a),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_turtle_msg_interface::msg::Numbers, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Numbers_message_members = {
  "my_turtle_msg_interface::msg",  // message namespace
  "Numbers",  // message name
  2,  // number of fields
  sizeof(my_turtle_msg_interface::msg::Numbers),
...
{
  return &::my_turtle_msg_interface::msg::rosidl_typesupport_introspection_cpp::Numbers_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_turtle_msg_interface, msg, Numbers)() {
  return &::my_turtle_msg_interface::msg::rosidl_typesupport_introspection_cpp::Numbers_message_type_support_handle;
}
