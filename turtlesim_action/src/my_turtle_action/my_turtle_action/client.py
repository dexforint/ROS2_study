...
class TargetPointActionClient(Node):
    def __init__(self):
        super().__init__('turtle_move_action_client')
        self._action_client = ActionClient(self, TargetPoint, 'turtle_move')
        ...
        self.get_logger().info('TargetPointActionClient запущен!')
...
def main(args=None):
    ...
    client = TargetPointActionClient()
    try:
